...
const API_AU_URL = `${environment.apiUrl}/quan-ly-doi-tac`;
...
export class PartnerService {
  ...
  getPartnerList(page: number, size: number): Observable<any> {
  ...
  getPartnerListSearch(page: number, size: number, input: string): Observable<any> {
